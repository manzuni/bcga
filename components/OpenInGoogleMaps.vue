...
<script setup>
const targetLocation = { lat: 51.4988508, lng: 0.2519783 };

function openGoogleMaps() {
  // Construct Google Maps URL
  const mapsUrl = `https://www.google.com/maps?q=${targetLocation.lat},${targetLocation.lng}&ll=${targetLocation.lat},${targetLocation.lng}&z=17`;

  // Open in a new tab or in the Maps app
